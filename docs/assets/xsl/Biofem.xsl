...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'biofem1-public-01']">
                ...
                <main id="manuscript">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm">
                                <h3>Faksimil</h3>
                                <p class="imagetext">Framsida affisch, originalversion (innan
                                    kopiering)</p>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <h3>Faksimil</h3>
                                <p class="imagetext">Baksida affisch, originalversion (innan
                                    kopiering)</p>
                                <xsl:for-each select="tei:facsimile">
                                    <article>
                                        <div class="zoom-window">
