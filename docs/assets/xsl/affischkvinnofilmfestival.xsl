...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'kvinnofilmfestival-public-01']">
                ...
                <main id="manuscript">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                <h3>Faksimil</h3>
                                <p class="imagetext">Baksida av affisch, med text skriven med
                                    blyerts. Okänt när den handskrivna texten tillkommit.</p>
                                <xsl:for-each select="tei:facsimile">
                                    <article>
                                        <div class="zoom-window">
                                            <!-- make an HTML <img> element, with a maximum width of 400 pixels -->
    ...
    <xsl:template match="tei:head[@xml:id = 'kvinnofilmfestival-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
