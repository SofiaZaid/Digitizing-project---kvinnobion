...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'kvinnohuset-public-01']">
    ...
    html-->
                            ...
                            <div class="col-sm transcription subsequentcolumn narrowcolumn">
                                <article>
                                    ...
                                    <xsl:apply-templates
                                        select="tei:text/tei:body/tei:div[2]/tei:p[4]"/>
                            ...
                            <div class="col-sm transcription subsequentcolumn">
                                <article>
                                    <xsl:apply-templates
                                        select="tei:text/tei:body/tei:div[2]/tei:p[6]"/>
                                    <xsl:apply-templates
                                        select="tei:text/tei:body/tei:div[2]/tei:p[7]"/>
                                </article>
                            </div>
                        </div>
                    </div>
                    <div class="footerinfo">
                        <xsl:apply-templates select="tei:text/tei:body/tei:div[2]/tei:p[5]"/>
                    </div>
                </main>
                <footer>
    ...
    <xsl:template match="tei:head[@xml:id = 'malou-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
