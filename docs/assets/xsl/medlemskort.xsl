...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'medlemskort1-public-01']">
                ...
                <main id="manuscript">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm">
                                <h3>Faksimil</h3>
                                <p class="imagetext">Framsida och baksida av medlemskort</p>
    ...
    <xsl:template match="tei:head[@xml:id = 'medlemskort1-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
