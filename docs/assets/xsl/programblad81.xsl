...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id='programblad3-public-01']">
        ...
        <html lang="en" xml:lang="en">
            ...
            <body>
                ...
                <nav id="sitenav">
                    ...
                    <a href="about.html">Om och Resurser</a></nav>
                <main id="manuscript">
                                    ...
                                    <article>
                                        ...
                                        <img class="img-full zoom">
                                            ...
                                            <xsl:attribute name="src">
                                                <xsl:value-of select="tei:surface/tei:figure/tei:graphic[1]/@url"/>
                                            </xsl:attribute>
                                            <xsl:attribute name="title">
                                                <xsl:value-of select="tei:surface/tei:figure/tei:label"/>
                                            </xsl:attribute>
    ...
    <xsl:template match="tei:head [@xml:id='programblad3-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
