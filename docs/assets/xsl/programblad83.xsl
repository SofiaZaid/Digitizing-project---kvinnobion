...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'programblad5-public-01']">
            ...
            <body>
                ...
                <nav id="sitenav">
                    <a href="home.html">Hem</a> | <a href="gallery.html">Galleri</a> | <a
                        href="about.html">Om oss</a> | <a href="respources.html">Resurser</a></nav>
                <main id="manuscript">
                                        ...
                                        <div class="zoom-window">
                                            ...
                                            <img class="img-full zoom">
                                                ...
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                  select="tei:surface/tei:figure/tei:graphic[1]/@url"
                                                  />
                                                </xsl:attribute>
                                                <xsl:attribute name="title">
                                                  <xsl:value-of
                                                  select="tei:surface/tei:figure/tei:label"/>
                                                </xsl:attribute>
                                                <xsl:attribute name="alt">
                                                  <xsl:value-of
                                                  select="tei:surface/tei:figure/tei:figDesc"/>
                                                </xsl:attribute>
                                            </img>
                                        </div>
                                    </article>
    ...
    <xsl:template match="tei:head[@xml:id = 'programblad5-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
