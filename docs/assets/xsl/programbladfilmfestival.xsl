                                    ...
                                    <article>
                                        <div class="zoom-window">
                                            ...
                                            <img class="img-full zoom">
                                                ...
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                  select="tei:surface[3]/tei:figure/tei:graphic[1]/@url"
                                                  />
                                                </xsl:attribute>
                                                <xsl:attribute name="title">
                                                  <xsl:value-of
                                                  select="tei:surface[3]/tei:figure/tei:label"/>
                                                </xsl:attribute>
                                                <xsl:attribute name="alt">
                                                  <xsl:value-of
                                                  select="tei:surface[3]/tei:figure/tei:figDesc"/>
                                                </xsl:attribute>
                                            </img>
                                        </div>
                                    </article>
                                    ...
                                    <article>
                                        ...
                                        <div class="zoom-window">
                                            <img class="img-full zoom">
                                                ...
                                                <xsl:attribute name="src">
                                                  <xsl:value-of
                                                  select="tei:surface[4]/tei:figure/tei:graphic[1]/@url"
                                                  />
                                                </xsl:attribute>
                                                <xsl:attribute name="title">
                                                  <xsl:value-of
                                                  select="tei:surface[4]/tei:figure/tei:label"/>
                                                </xsl:attribute>
                                                <xsl:attribute name="alt">
                                                  <xsl:value-of
                                                  select="tei:surface[4]/tei:figure/tei:figDesc"/>
                                                </xsl:attribute>
                                            </img>
                                        </div>
                                    </article>
