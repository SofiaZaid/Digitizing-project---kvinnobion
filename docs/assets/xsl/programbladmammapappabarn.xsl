...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="tei:TEI[@xml:id = 'programblad7-public-01']">
            ...
            <body>
                ...
                <nav id="sitenav">
                    <a href="home.html">Hem</a> | <a href="gallery.html">Galleri</a> | <a
                        href="about.html">Om oss</a> | <a href="respources.html">Resurser</a>
                </nav>
                <main id="manuscript">
    ...
    <xsl:template match="tei:head[@xml:id = 'programblad7-public-01']">
        <h2>
            <xsl:apply-templates/>
        </h2>
    </xsl:template>
